...
export const get_franchise = async (body) => {
  try {
    const response = await axiosInstance.post(
      API_ENDPOINTS.GET_FRANCHISE,
      body
    );
    return response.data;
  } catch (error) {
...
export const running_franshise = async (body) => {
  try {
    const response = await axiosInstance.post(
      API_ENDPOINTS.RUNNING_FRANCHISE,
      body
    );
    return response.data;
  } catch (error) {
...
export const franchise_location_list = async (body) => {
  try {
    const response = await axiosInstance.get(
      API_ENDPOINTS.FRANCHISE_LOCATION,
      body
    );
    return response.data;
  } catch (error) {
...
export const investment_estimate = async (body) => {
  try {
    const response = await axiosInstance.post(
      API_ENDPOINTS.INVESTMENT_ESTIMATE,
      body
    );
    return response.data;
  } catch (error) {
