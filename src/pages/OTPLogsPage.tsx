...
const OTPLogsPage = () => {
  ...
  const otpLogs = [
    { id: 1, phone: '+91 9876543210', user: 'John Doe', purpose: 'booking', status: 'verified', createdAt: '2025-02-24 09:15:32', verifiedAt: '2025-02-24 09:16:45' },
    { id: 2, phone: '+91 9876543211', user: 'Jane Smith', purpose: 'login', status: 'verified', createdAt: '2025-02-24 10:30:12', verifiedAt: '2025-02-24 10:31:05' },
    { id: 3, phone: '+91 9876543212', user: 'Robert Johnson', purpose: 'registration', status: 'expired', createdAt: '2025-02-24 11:45:23', verifiedAt: null },
    { id: 4, phone: '+91 9876543213', user: 'Emily Williams', purpose: 'pickup', status: 'verified', createdAt: '2025-02-24 12:10:45', verifiedAt: '2025-02-24 12:12:30' },
    { id: 5, phone: '+91 9876543214', user: 'Michael Brown', purpose: 'booking', status: 'failed', createdAt: '2025-02-24 13:25:18', verifiedAt: null },
    { id: 6, phone: '+91 9876543215', user: 'Sarah Davis', purpose: 'login', status: 'verified', createdAt: '2025-02-24 14:40:09', verifiedAt: '2025-02-24 14:41:22' },
    { id: 7, phone: '+91 9876543216', user: 'David Miller', purpose: 'registration', status: 'verified', createdAt: '2025-02-24 15:55:37', verifiedAt: '2025-02-24 15:57:14' },
    { id: 8, phone: '+91 9876543217', user: 'Emma Wilson', purpose: 'pickup', status: 'expired', createdAt: '2025-02-24 17:10:42', verifiedAt: null },
  ];
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold mt-1">{otpLogs.filter(log => log.status === 'verified').length}</h3>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold mt-1">{otpLogs.filter(log => log.status === 'expired').length}</h3>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold mt-1">{otpLogs.filter(log => log.status === 'failed').length}</h3>
              </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="text-left border-b border-gray-200">
                  ...
                  <th className="px-4 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">Purpose</th>
                  <th className="px-4 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">Status</th>
                  <th className="px-4 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">Created At</th>
                  <th className="px-4 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">Verified At</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200">
                {paginatedLogs.map((log) => (
                  <tr key={log.id} className="hover:bg-gray-50">
                    <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">#{log.id}</td>
                    <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">{log.phone}</td>
                    <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">{log.user}</td>
                    ...
                    <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">{log.createdAt}</td>
                    <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">{log.verifiedAt || '-'}</td>
                  </tr>
                ))}
              </tbody>
            </table>
