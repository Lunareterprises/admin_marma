...
import TherapistModal from "./Therapist/AddmodalTherapist";
...
const TherapistsPage = () => {
  ...
  const [therapists, setTherapists] = useState<Therapist[]>([]);
    useEffect(() => {
      const fetchStats = async () => {
        try {
          const res = await fetch("/data/therapist.json"); // or your API URL
  ...
  const filteredTherapists = therapists.filter((therapist) => {
    ...
    if (selectedFilter === "approved")
      return matchesSearch && therapist.status === "approved";
    if (selectedFilter === "pending")
      return matchesSearch && therapist.status === "pending";
    if (selectedFilter === "rejected")
      return matchesSearch && therapist.status === "rejected";
    if (selectedFilter === "online")
      return matchesSearch && therapist.availability === "online";
    if (selectedFilter === "offline")
      return matchesSearch && therapist.availability === "offline";
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Manage therapist accounts and applications
          </p>
        </div>
        <Button className="mt-4 md:mt-0 text-[12px] md:text-[12px] " size="lg"  onClick={() => setIsModalOpen(true)}>
        ...
        apiUrl="https://your-api.com/doctors/add"
      />
                ...
                <h3 className="text-2xl font-bold mt-1">
                  {
                    therapists.filter(
                      (t) =>
                        t.availability === "online" && t.status === "approved"
                    ).length
                  }
                </h3>
              </div>
